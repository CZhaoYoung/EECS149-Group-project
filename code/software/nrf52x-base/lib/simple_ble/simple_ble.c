...
void __attribute__((weak)) advertising_start(void) {
    ...
    //uint32_t err_code = sd_ble_gap_adv_start(&(m_advertising.adv_param);
...
void __attribute__((weak)) advertising_start_connection(void) {
    
    sd_ble_gap_adv_set_configure(&m_advertising.adv_handle, &m_advertising.adv_data, &m_advertising.adv_params);

    uint32_t err_code = sd_ble_gap_adv_start(m_advertising.adv_handle, BLE_CONN_CFG_TAG_DEFAULT);
